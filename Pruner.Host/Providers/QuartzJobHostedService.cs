...
namespace Pruner.Host.Providers
{
    /// <summary>
    /// 定时任务启动服务
    /// </summary>
    public class QuartzJobHostedService : IHostedService
    {
        ...
        private readonly ISysGlobalExceptionLogHttpService _service;
        ...
        public QuartzJobHostedService(
            ...
            ISysGlobalExceptionLogHttpService service,
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            foreach (var jobSchedule in _config.ScheduleJobs)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    await _service.AddAsync(new SysGlobalExceptionLogRequest()
                    {
